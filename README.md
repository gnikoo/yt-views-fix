...
> Note: unpacked extensions will show a warning on startup that can be dismissed. For a permanent install, the extension will become available on the Chrome Web Store after it is reviewed. This README will be updated with the link once the extension is published.
